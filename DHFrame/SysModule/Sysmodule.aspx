                                ...
                                <ext:FieldSet ID="FieldSet1"
                                    ...
                                    <Items>
                                        <ext:Panel
                                            ...
                                            <Items>
                                                <ext:TextField ID="TextField1" runat="server" LabelWidth="80" Width="210" LabelAlign="Right" FieldLabel="模块名"></ext:TextField>
                                                <ext:TextField ID="TextField2" LabelWidth="80" Width="210" LabelAlign="Right" runat="server" FieldLabel="编号"></ext:TextField>
                                                <ext:ComboBox runat="server"
                                                    ...
                                                    Width="210">
                                                    <Items>
                                                        <ext:ListItem Text="应用"></ext:ListItem>
                                                        <ext:ListItem Text="页面"></ext:ListItem>
                                                        <ext:ListItem Text="入口"></ext:ListItem>
                                                    </Items>
                                                </ext:ComboBox>
                                                <ext:TextField ID="TextField4" LabelWidth="80" Width="210" LabelAlign="Right" runat="server" FieldLabel="排序号"></ext:TextField>
                                                <ext:TextField ID="TextField3" runat="server" LabelAlign="Right" Width="420" LabelWidth="80" Flex="1" ColSpan="2" FieldLabel="URL"></ext:TextField>
                                                <ext:TextField ID="TextField5" runat="server" LabelAlign="Right" Width="420" LabelWidth="80" Flex="1" ColSpan="2" FieldLabel="图标"></ext:TextField>
                                                <ext:TextField runat="server" LabelAlign="Right" Width="420" LabelWidth="80" Flex="1" ColSpan="2" FieldLabel="描述"></ext:TextField>
                                            </Items>
                                        </ext:Panel>
                                    </Items>
                                </ext:FieldSet>
                                <ext:FieldSet ID="FieldSet2"
                                    ...
                                    <Items>
                                        <ext:Panel
                                            ...
                                            <Items>
                                                <ext:Checkbox runat="server" X="0" Y="10" LabelAlign="Right" FieldLabel="快速搜索"></ext:Checkbox>
                                                <ext:Checkbox runat="server" X="120" Y="10" LabelAlign="Right" FieldLabel="可回收"></ext:Checkbox>
                                            </Items>
                                        </ext:Panel>
                                    </Items>
                                </ext:FieldSet>
